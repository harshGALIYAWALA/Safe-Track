...
import com.example.android.databinding.ActivityRegisterScreenBinding
import com.example.android.model.UserProfileModel
...
class register_screen : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(com.example.android.R.id.main)) { v, insets ->
